      ...
      /***/ function (module, exports) {
        ...
        CropArea.prototype.processMouseMove = function (mouseCurX, mouseCurY) {
          ...
          if (this._resizeCtrlIsDragging > -1) {
            ...
            console.log(mouseCurX, this._posResizeStartX, xMulti, wasW, this.w, _xPosModifier);
            if (ltx) {
        ...
        Cropper.prototype.applyRotation = function (degree) {
          ...
          if (this.options.triggerOnChange) {
        ...
        Cropper.prototype.initCanvas = function () {
          ...
          this.area = new CropArea(_elements.wrapper.canvas);
          this.area.drawScene();
        }
        /**
        ...
        Cropper.prototype.initializeGesture = function () {
          ...
          this.addEventListeners(window.document, self.gesture.events.move, function (event) {
            if (self.isReady) {
          ...
          this.addEventListeners(self.area.canvas, self.gesture.events.start, function (event) {
        ...
        Cropper.prototype.cropHandler = function () {
          ...
          tempImg.onload = function () {
            ...
            self.events.triggerHandler('Cropped', canvas.toDataURL('image/jpeg'));
          }
          tempImg.src = base64;
            ...
            .directive('imageCropper', function () {
              return {
                ...
                controller: function () {
                  ...
                  this.triggerOnChange = eval(this.triggerOnChange);
